...
do
    ...
    do
        ...
        torchrun --nnodes=1 --master_port=$PORT --nproc_per_node=1 run_class_finetuning.py \
            --dataset_dir datasets/ecg_datasets/PTBXL_QRS_6Leads/subdiagnostic \
            --output_dir checkpoints/finetune/ptbxl/finetune_subdiagnostic_base_6Leads_linear_${ratio}_${method}/ \
            --log_dir log/finetune/finetune_subdiagnostic_base_6Leads_linear_${ratio}_${method} \
...
do
    ...
    do
        ...
        torchrun --nnodes=1 --master_port=$PORT --nproc_per_node=1 run_class_finetuning.py \
            --dataset_dir datasets/ecg_datasets/PTBXL_QRS_6Leads/subdiagnostic \
            --output_dir checkpoints/finetune/ptbxl/finetune_subdiagnostic_base_6Leads_linear_${ratio}_${method}/ \
            --log_dir log/finetune_test/finetune_subdiagnostic_base_6Leads_linear_${ratio}_${method} \
            --model HeartLang_finetune_base \
            --eval \
            --trainable linear \
            --split_ratio $ratio \
