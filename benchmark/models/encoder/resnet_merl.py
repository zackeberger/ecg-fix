...
from benchmark.models.encoder.ecg_embedder import ECGEmbedder
...
class ResNet(ECGEmbedder):
    def __init__(self, block, num_blocks, num_channels=12):
    ...
    def load_weights(self, path):
        ...
        assert not torch.equal(y_new, y)
